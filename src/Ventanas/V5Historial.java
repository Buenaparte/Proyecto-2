...
public class V5Historial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Numero de Habitación");
        panelRound1.add(jLabel4);

        getContentPane().add(panelRound1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 210, 170, -1));

        numeroHabitacion.setBackground(new java.awt.Color(0, 169, 105));
        numeroHabitacion.setForeground(new java.awt.Color(255, 255, 255));
        numeroHabitacion.setText("0000000000");
        numeroHabitacion.setBorder(null);
        numeroHabitacion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                numeroHabitacionActionPerformed(evt);
            }
        });
        getContentPane().add(numeroHabitacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 210, 90, 30));

        jPanel2.setBackground(new java.awt.Color(253, 250, 249));
        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/6_1.png"))); // NOI18N
